...
const CardGroup2 = () => {
    const products = [
        {name: '-PALLAVI SHARMA', says: "I hav been a loyal customer and I buy a lot of VAGANIC products. I recently tried their VAGANIC Biryani Masala. My Biryani tasted delicious with VEGANIC extra touch. Definitely going to add that to my grocerry list."},
        { name: '-Dr. RUTUJA', says: "VEGANIC'S Dal, is actually unpolished and worth the price. Same taste but more healthy. Glad to have bought this dal from VEGANIC." },
        { name: '-JEWEL NABIN', says: "I love VEGANIC'S behaviours and services. Their all products touch to my heart." },
